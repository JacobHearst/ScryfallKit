...
extension ScryfallClient {
    ...
    public func getCardNameAutocomplete(query: String, includeExtras: Bool? = nil) async throws -> Catalog {
    ...
    public func getRulings(_ identifier: Card.Ruling.Identifier) async throws -> ObjectList<Card.Ruling> {
